...
from khronos_enum_to_dive_body_generator import KhronosEnumToDiveBodyGenerator
from reformat_code import format_cpp_code


class VulkanEnumToDiveBodyGeneratorOptions(VulkanBaseGeneratorOptions):
...
class VulkanEnumToDiveBodyGenerator(VulkanBaseGenerator, KhronosEnumToDiveBodyGenerator):
    ...
    # Method override
    def endFile(self):
        KhronosEnumToDiveBodyGenerator.make_decls(self)
