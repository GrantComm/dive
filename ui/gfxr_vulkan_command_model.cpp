...
//--------------------------------------------------------------------------------------------------
bool GfxrVulkanCommandModel::EventNodeHasMarker(uint64_t node_index) const
{
    return false;
}

//--------------------------------------------------------------------------------------------------
char GfxrVulkanCommandModel::GetEventNodeStream(uint64_t node_index) const
{
    return '\0';
}

//--------------------------------------------------------------------------------------------------
uint32_t GfxrVulkanCommandModel::GetEventNodeIndexInStream(uint64_t node_index) const
{
    return UINT32_MAX;
}
...
{
    std::cout << "GfxrVulkanCommandModel::search 0" << std::endl;
