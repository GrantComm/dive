...
bool GfxrVulkanCommandHierarchyCreator::CreateTrees(CommandHierarchy       *command_hierarchy_ptr,
...
//--------------------------------------------------------------------------------------------------
uint64_t GfxrVulkanCommandHierarchyCreator::AddNode(NodeType      type,
                                                    std::string &&desc,
                                                    char         *metadata_ptr,
...
void GfxrVulkanCommandHierarchyCreator::GetArgs(const nlohmann::ordered_json &j,
                                                uint64_t                      curr_index,
...
//--------------------------------------------------------------------------------------------------
bool GfxrVulkanCommandHierarchyCreator::OnCommand(
