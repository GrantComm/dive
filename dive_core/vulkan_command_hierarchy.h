...
// client for this class is the Model class for the Vulkan command and argument Views in the UI.
// =====================================================================================================================
...
class VulkanCommandHierarchyCreator : public CommandHierarchyCreator
{
    ...
    private:
        void GetArgs(const nlohmann::ordered_json& j, uint64_t curr_index, const std::string& current_path = "");
        ...
        /*void AddArgChild(CommandHierarchy::TopologyType type,
                uint64_t                       node_index,
                uint64_t                       child_node_index);*/
        ...
        bool OnCommand(uint32_t submit_index, DiveAnnotationProcessor::VulkanCommandInfo vk_cmd_info);
