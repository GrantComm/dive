...
// =================================================================================================
CommandHierarchyCreator::CommandHierarchyCreator(CommandHierarchy &command_hierarchy, EmulateStateTracker &state_tracker) :
    m_command_hierarchy(command_hierarchy), m_state_tracker(state_tracker)
{
                                          ...
                                          ILog                   *log_ptr)
{
    ...
    m_command_hierarchy = command_hierarchy_ptr;
